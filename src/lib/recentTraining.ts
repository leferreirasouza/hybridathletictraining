// Client mirror of supabase/functions/_shared/recentTraining.ts.
// Same math, so the wizard prefill matches what the plan generator computes
// server-side. Keep both files aligned if either changes.
